...
#'
#' Strings of zeros in `df$C` may introduce spurious zeros
#' and large numeric elements in column `beta` of the output.
#' To prevent these errors, zeros in `df$C` are imputed like
